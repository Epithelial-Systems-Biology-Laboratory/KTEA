...
de_genes %>%
  ...
  guides(fill=guide_colorbar(ticks = FALSE,
                             ...
                             barheight = 0.01,
                             default.unit = "npc")) +
  annotate("rect", xmin=-0.5,xmax=0.5,ymin=0.5,ymax=33.5 , alpha=0.5, fill = "#fdb462") +
  annotate("text", x=-0.5,y=33.5/2,label="Proximal Tubules",angle=90, vjust=1.5, size = 8/.pt) +
  annotate("rect", xmin=-0.5,xmax=0.5,ymin=33.5,ymax=64.5 , alpha=0.5, fill = "#80b1d3") +
  annotate("text", x=-0.5,y=33.5 + 31.5/2,label="Descending limb",angle=90, vjust=1.5, size = 8/.pt) +
  annotate("rect", xmin=-0.5,xmax=0.5,ymin=64.5,ymax=74.5 , alpha=0.5, fill = "#fb8072") +
  annotate("text", x=-0.5,y=64.5 + 10.5/2,label="ATL",angle=90, vjust=1.5, size = 8/.pt) + 
  annotate("rect", xmin=-0.5,xmax=0.5,ymin=74.5,ymax=93.5 , alpha=0.5, fill = "#bebada") +
  annotate("text", x=-0.5,y=74.5 + 17.5/2,label="TAL",angle=90, vjust=1.5, size = 8/.pt) +
  annotate("rect", xmin=-0.5,xmax=0.5,ymin=93.5,ymax=102.5 , alpha=0.5, fill = "#ffffb3") +
  annotate("text", x=-0.5,y=93.5 + 9.5/2,label="DCT",angle=90, vjust=1.5, size = 8/.pt) +
  annotate("rect", xmin=-0.5,xmax=0.5,ymin=102.5,ymax=137.5 , alpha=0.5, fill = "#8dd3c7") +
  annotate("text", x=-0.5,y=102.5 + 35.5/2,label="CNT/CD",angle=90, vjust=1.5, size = 8/.pt) 

ggsave(snakemake@output[[1]], height = 9, width = small.width)
dev.off()
